...
import "./Footer.css";
import facebook from "../../../assets/images/facebbok";
      ...
      <div className="content">
        ...
        <div>
          ...
          <div className="list ">
            ...
            <div>
            <img style={{ marginRight: "10px" }} src="https://statics.olx.in/external/base/img/playstore.png" alt="Download OLX in the Android Play Store" class="Wn0Dp"/> 
          
            <img src="https://statics.olx.in/external/base/img/appstore.png" alt="Download OLX for iOS in the Apple App Store" class="Wn0Dp"/>
             </div>
          </div>
        </div>
      </div>
